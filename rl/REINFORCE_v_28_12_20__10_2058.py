...
class REINFORCE:
    ...
    def build_policy_network(self):
        ...
        model_game_grid = Conv2D(4, (3, 3))(input_game_grid)
        ...
        model_shape_queue_0 = Conv2D(
            4, (3, 3), activation="relu")(input_shape_queue_0)
        ...
        model_shape_queue_1 = Conv2D(
            4, (3, 3), activation="relu")(input_shape_queue_1)
        ...
        model_shape_queue_2 = Conv2D(
            4, (3, 3), activation="relu")(input_shape_queue_2)
        ...
        model_output = Dense(64, activation="relu")(combined)
