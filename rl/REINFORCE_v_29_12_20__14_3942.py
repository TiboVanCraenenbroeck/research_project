...
class REINFORCE:
    ...
    def build_policy_network(self):
        ...
        model_shape_queue_0 = Conv2D(
            8, (3, 3), activation="relu")(input_shape_queue_0)
        #model_shape_queue_0 = LeakyReLU()(model_shape_queue_0)

        model_shape_queue_0 = Flatten()(model_shape_queue_0)
        model_shape_queue_0 = Dense(72, activation="relu")(model_shape_queue_0)
        #model_shape_queue_0 = LeakyReLU()(model_shape_queue_0)
        ...
        model_output = Dense(584, activation="relu")(combined)
        #model_output = LeakyReLU()(model_output)

        model_output = Dense(292, activation="relu")(model_output)
        #model_output = LeakyReLU()(model_output)

        model_output = Dense(146, activation="relu")(model_output)
        #model_output = LeakyReLU()(model_output)
