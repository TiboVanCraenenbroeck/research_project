...
class REINFORCE:
    def __init__(self, path=None):
        ...
        self.gamma = 0.1  # decay rate of past observations
    ...
    def build_policy_network(self):
        ...
        model_game_grid = Conv2D(2, (3, 3))(input_game_grid)
        model_game_grid = Flatten()(model_game_grid)
        model_game_grid = Dense(3850)(model_game_grid)
        model_game_grid = LeakyReLU()(model_game_grid)

        model_game_grid = Dense(1283)(model_game_grid)
        model_game_grid = LeakyReLU()(model_game_grid)

        model_game_grid = Dense(427)(model_game_grid)
        model_game_grid = LeakyReLU()(model_game_grid)
        model_game_grid = Model(inputs=input_game_grid,
                                outputs=model_game_grid, name="Model_GameGrid")

        model_shape_queue_0 = Conv2D(2, (3, 3))(input_shape_queue_0)
        model_shape_queue_0 = LeakyReLU()(model_shape_queue_0)

        model_shape_queue_0 = Flatten()(model_shape_queue_0)
        model_shape_queue_0 = Dense(1410)(model_shape_queue_0)
        model_shape_queue_0 = LeakyReLU()(model_shape_queue_0)

        model_shape_queue_0 = Dense(470)(model_shape_queue_0)
        model_shape_queue_0 = LeakyReLU()(model_shape_queue_0)

        model_shape_queue_0 = Dense(156)(model_shape_queue_0)
        model_shape_queue_0 = LeakyReLU()(model_shape_queue_0)
        ...
        model_output = Dense(
            self.action_shape, activation="sigmoid")(model_output)
    ...
    def train_policy_network(self):
        ...
        history = self.model.train_on_batch(
            [imgs_game_grid, imgs_shape_queue0], y_train)
